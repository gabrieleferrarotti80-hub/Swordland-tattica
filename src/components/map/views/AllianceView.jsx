  ...
  return (
    <g>
      {fixedBuildings.map(building => {
        ...
        else if (isHarvest) { fillColor = "rgba(163, 230, 53, 0.4)"; strokeColor = "#a3e635"; }
        else if (isScholar) { fillColor = "rgba(99, 102, 241, 0.4)"; strokeColor = "#6366f1"; }
        else if (isArmory) { fillColor = "rgba(244, 63, 94, 0.4)"; strokeColor = "#f43f5e"; }
        else if (isArsenal) { fillColor = "rgba(239, 68, 68, 0.4)"; strokeColor = "#ef4444"; }
        else if (isDrill) { fillColor = "rgba(20, 184, 166, 0.4)"; strokeColor = "#14b8a6"; }
        else if (isFrontier) { fillColor = "rgba(56, 189, 248, 0.4)"; strokeColor = "#38bdf8"; }
